...
// GetBucketTagging gets tagging configuration for a bucket with a context to control cancellations and timeouts.
...
// DeleteBucketTagging removes tagging configuration for a bucket with a context to control cancellations and timeouts.
