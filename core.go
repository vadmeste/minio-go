...
func (c Core) ListObjects(ctx context.Context, bucket, prefix, marker, delimiter string, maxKeys int) (result ListBucketResult, err error) {
...
func (c Core) ListObjectsV2(ctx context.Context, bucketName, objectPrefix, continuationToken string, fetchOwner bool, delimiter string, maxkeys int, startAfter string) (ListBucketV2Result, error) {
...
// PutBucketPolicy - applies a new bucket access policy for a given bucket with a context to control
